...
import { set, remove } from "../../../../redux/modules/parameter";
import List from "../../../../components/Parameter/List";
import Delete from "../../../../components/DeleteModal";
import NewButton from "../../../../components/Common/HeaderButton";

import { parameters } from "./parameterMock";
...
const Test = () => {
  ...
  const list = useSelector((globalState) => globalState.parameters.data);
